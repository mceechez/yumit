...
Track scan usage in localStorage under `yumit_usage`:
...
> "🧺 Yumit has saved you time on 10 shops now.
> 
...
> "💡 Enjoying Yumit? Add your own API key in Settings to keep it free for everyone."
...
as described in the Yumit — Brief Amendment 1 document. Build it after 
