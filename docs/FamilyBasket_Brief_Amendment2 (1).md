...
On every meal card in the Household Favourites, Adult Meals, and Children's Meals sections, add a delete button (🗑 icon, top right of card).
...
management features from Yumit — Brief Amendment 2 — individual meal 
