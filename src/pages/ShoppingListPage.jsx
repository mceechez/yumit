        ...
        <Card className="text-center py-8">
          <div className="space-y-4">
            <div className="w-16 h-16 bg-basket-orange-100 rounded-full flex items-center justify-center mx-auto">
              <svg className="w-8 h-8 text-basket-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">
                AI creates a shopping list based on your family&apos;s favourite meals
              </p>
            </div>
      ...
      {shoppingList && (
        <div className="space-y-4 print:space-y-2">
          ...
          <div className="hidden print:block text-center mb-4">
            <h1 className="text-2xl font-bold">FamilyBasket Shopping List</h1>
          ...
          {shoppingList.gapFillers?.length > 0 && (
            <Card className="bg-blue-50 border-blue-200 print:border print:bg-white">
              <CardTitle className="text-blue-800">Nutrition Gap Fillers</CardTitle>
              <p className="text-sm text-blue-600 mb-2">Added to balance the family&apos;s nutrition</p>
              <div className="space-y-1">
          ...
          {shoppingList.estimatedTotal && (
            <Card className="bg-basket-green-50 border-basket-green-200 print:border print:bg-white">
              <div className="flex items-center justify-between">
                <span className="font-semibold text-basket-green-800">Estimated Total</span>
                <span className="text-2xl font-bold text-basket-green-600">
